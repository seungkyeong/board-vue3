<template>
  <div class="container">
    ...
    <el-text class="find-text">고객님의 정보와 일치하는 아이디 입니다.</el-text>
    <div class="formAndBut-container">
      <div class="form-container">
        <el-form :model="form" label-width="auto" style="width: 100%">
          <el-form-item>
            <el-text v-model="form.result" class="result-text">{{
              result
            }}</el-text>
          </el-form-item>
        </el-form>
      ...
      <div class="button-container">
        <el-button type="primary" @click="toLogin" style="width: 100%"
          >로그인하기</el-button
        >
        <el-button type="primary" @click="toFindPw" style="width: 100%"
          >비밀번호 찾기</el-button
        >
      </div>
    </div>
